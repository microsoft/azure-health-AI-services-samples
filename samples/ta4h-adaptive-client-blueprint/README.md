...
The following instructions describe step-by-step how to deploy this solution on Azure. We use the azure cli here but you can also do almost all of the steps directly the azure portal.
